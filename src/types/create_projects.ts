...
export interface FormStepProps {
  ...
  onInputChange: (field: keyof ProjectFormData, value: string | number | boolean) => void
  errors: Record<string, string>
}

export interface MilestoneStepProps extends FormStepProps {
  onMilestoneChange: (index: number, field: keyof Milestone, value: string | number | boolean) => void
  onAddMilestone: () => void
