    ...
    <div className="space-y-6">
      ...
      <div className="space-y-6">
        {formData.milestones?.map((milestone, index) => (
          <Card
            key={index}
            className="p-6 border-2 border-gray-200 hover:border-gray-300 transition-colors"
          >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                ...
                <Input
                  ...
                  onChange={(e) =>
                    onMilestoneChange(index, "name", e.target.value)
                  }
                  placeholder="e.g., Design Phase"
                  className={`mt-2 ${
                    errors[`milestones.${index}.name`] ? "border-red-500" : ""
                  }`}
                  maxLength={100}
                />
              ...
              <div className="md:col-span-2">
                ...
                <Textarea
                  ...
                  onChange={(e) =>
                    onMilestoneChange(index, "description", e.target.value)
                  }
              ...
              <div className="md:col-span-2 mt-4">
                <div className="border border-blue-200 bg-blue-50 rounded-lg p-4">
                  ...
                  <p className="text-sm text-blue-700 mt-2">
                    Client gets {milestone.free_revisions ?? 2} free revisions
                    for this milestone, then ${milestone.revision_rate ?? 50}{" "}
