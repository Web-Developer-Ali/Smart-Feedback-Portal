    ...
    <div className="min-h-screen bg-gradient-to-br from-purple-50 via-white to-blue-50 flex items-center justify-center p-4">
      <div className="w-full max-w-lg">
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600 mt-2">Join Smart Feedback Portal as an Agency</p>
        </div>

        <Card className="shadow-xl border-0 bg-white/80 backdrop-blur-sm">
          <CardHeader className="space-y-1 pb-4">
            <CardTitle className="text-2xl font-semibold text-center">Agency Sign Up</CardTitle>
            <CardDescription className="text-center text-gray-500">Provide feedback services to clients</CardDescription>
          </CardHeader>
